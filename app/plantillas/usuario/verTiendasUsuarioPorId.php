                   ...
                   foreach ($tiendaTotal as $key => $value) {
                     echo '<div class="slag">';
                        echo '<div class="thumbnail">';
                           echo '<a href="index.php?ctl=verTiendasUsuario&idTienda='.$value->getIdTienda().'" ><img src="'.$value->getImagenTienda().'"
                           alt="imagen de tienda" title="imagen de tienda" style="width:209px;height:139px;"></a>';
                           echo '<div class="caption">';
                              echo '<h4><a href="index.php?ctl=verTiendasUsuario&idTienda='.$value->getIdTienda().'" >'.$value->getNombre().'</a>';
                              echo '</h4>';
