		...
		echo '<div class="row">';
			echo '<div class="col-xs-12 col-md-12 col-lg-12 content_home">';
				...
				echo '<p class="pull-center">
                    <span><a href="index.php?ctl=verLibrosPorBoton&categoria='.$arrayLibro['NombreCategoria'].'&redireccion=usuario"><button type="button" class="btn btn-default">
                    ' . $arrayLibro['NombreCategoria'] . '</button></a></span>
                    <span><a href="index.php?ctl=verLibrosPorBoton&subCategoria='.$arrayLibro['NombreSubCategoria'].'&redireccion=usuario"><button type="button" class="btn btn-default">
                    ' . $arrayLibro['NombreSubCategoria'] . '</button></a></span>
                    <span><a href="index.php?ctl=verLibrosPorBoton&editorial='.$arrayLibro['NOMBRE_EDITORIAL'].'&redireccion=usuario"><button type="button" class="btn btn-default">Editorial:
                    ' . $arrayLibro['NOMBRE_EDITORIAL'] . '</button></a></span></p><br>';

				echo '<ul class="list-inline">';
					echo '<li><a href="index.php?ctl=verLibrosPorBoton&yearPublicacion='.$arrayLibro['YearPublicacion'].'&redireccion=usuario"><button type="button" class="btn btn-default">Año publicación
					: ' . $arrayLibro['YearPublicacion'] . '</button></a></li>';
					echo '<li><a href="index.php?ctl=verLibrosPorBoton&autor='.$arrayLibro['nombre_autor'].'&redireccion=usuario"><button type="button" class="btn btn-default">Autor
				...
				echo '<form class="formBusqueda" name="formBusquedaLibro" method="POST" action="index.php?ctl=comprarLibroUsuarioReserva">';
					echo '<p class="lead">';
						...
						echo '<input type="hidden" name="idLibro" value="'.$arrayLibro['IdLibro'].'">';
						echo '<input type="hidden" name="IdEjemplar" value="'.$arrayLibro['IdEjemplar'].'">';
					echo '</p>';
				echo '</form>';
