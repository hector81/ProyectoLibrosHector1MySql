	...
	foreach ($resultadosBusqueda as $key => $libroIndividual) {
		echo '<div class="slag" style="width: 33.333333333333333333%;float: left;display:block;height:641px;margin-bottom:2em;margin-top:3em;">';
			echo '<div class="thumbnail">';
				echo '<a href="index.php?ctl=verLibrosIndividualUsuario&idLibro='.$libroIndividual['ID_LIBRO'].'&nombreCategoria='.$libroIndividual['NOMBRE_CATEGORIA'].'">
				<img src="'.$libroIndividual['PORTADA_EJEMPLAR'].'" alt="'.$libroIndividual['TITULO_LIBRO'].'"></a>';
				echo '<div class="caption">';
					echo '<h4><a href="index.php?ctl=verLibrosIndividualUsuario&idLibro='.$libroIndividual['ID_LIBRO'].'&nombreCategoria='.$libroIndividual['NOMBRE_CATEGORIA'].'">
