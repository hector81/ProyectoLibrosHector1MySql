...
foreach ($listaUsuarios as $key => $tipoUsuario) {
    ...
    if($tipoUsuario->getActivo()){
        echo '<a href="index.php?ctl=cambiarEstadoAdministradorTienda&email=' . $tipoUsuario->getEmail(). '&redireccion=listaIndividual&estado='.$tipoUsuario->getActivo().'">
    ...
    echo '<td style="word-break: break-all;">
        <a href="index.php?ctl=modificarAdministradorTienda&email=' . $tipoUsuario->getEmail() . '&redireccion=listaIndividual">
        <span class="glyphicon glyphicon-pencil"></span>
        </a>
        <a href="index.php?ctl=borrarAdministrador&email=' . $tipoUsuario->getEmail() . '&redireccion=listaIndividual">
        <span class="glyphicon glyphicon-remove"></span>
        </a>
        <a href="index.php?ctl=verAdministradorTiendaIndividual&email=' . $tipoUsuario->getEmail() . '&redireccion=listaIndividual">
