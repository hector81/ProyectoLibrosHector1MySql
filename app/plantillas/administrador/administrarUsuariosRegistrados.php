...
<?php
echo '<h2>USUARIOS</h2>';
echo '<p>En esta tabla estan todos los usuarios inscritos</p>';
...
foreach ($listaUsuarios as $key => $tipoUsuario) {
    ...
    if($tipoUsuario->getActivo()){
        echo '<a href="index.php?ctl=cambiarEstadoUsuario&email=' . $tipoUsuario->getEmail(). '&redireccion=listaIndividual&estado='.$tipoUsuario->getActivo().'">
    ...
    echo '<td style="word-break: break-all;">
        <a href="index.php?ctl=modificarUsuario&email=' . $tipoUsuario->getEmail(). '&redireccion=listaIndividual">
        <span class="glyphicon glyphicon-pencil"></span>
        </a>
        <a href="index.php?ctl=borrarUsuarios&email=' . $tipoUsuario->getEmail() . '&redireccion=listaIndividual">
        <span class="glyphicon glyphicon-remove"></span>
        </a>
        <a href="index.php?ctl=verUsuarioIndividual&email=' . $tipoUsuario->getEmail() . '&redireccion=listaIndividual">
