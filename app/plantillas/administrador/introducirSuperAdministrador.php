...
<form name="formularioUsuario" class="formularioUsuario" action="index.php?ctl=enviarDatosIntroduccionSuperAdministrador" method="POST" style="text-align:left;">
        <h2>Datos del super administrador a introducir</h2><br><br><br>
        ...
        <ul class="list-group">
            ...
            <div class="col-sm-12 col-md-6 col-lg-6">
                <label for="contraseniaUsuarioNUEVA">Contraseña del super administrador<span class="rojo">*</span></label>
        ...
        <input type="submit" value="Enviar datos super administrador" name="boton" ><br><br>
</form>
