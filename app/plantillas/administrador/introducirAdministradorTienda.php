...
<form name="formularioUsuario" class="formularioUsuario" action="index.php?ctl=enviarDatosIntroduccionAdministradorTienda" method="POST" style="text-align:left;">
        <h2>Datos del administrador de tienda a introducir</h2><br><br><br>
        <h4>Los datos con * rojo son obligatorios</h4>
            ...
            <div class="col-sm-12 col-md-6 col-lg-6">
                ...
                <input type="text" value=""  maxlength="100" name="eCorreoUsuario" id="eCorreoUsuario" class="form-control">
            </div>
            <div class="col-sm-12 col-md-6 col-lg-6">
                <label for="faxUsuario">Fax del usuario</label>
                <input type="text"  maxlength="9" value="" name="faxUsuario" id="faxUsuario" class="form-control">
            </div>
            <div class="col-sm-12 col-md-6 col-lg-6">
                <label for="contraseniaUsuarioNUEVA">Contraseña del administrador<span class="rojo">*</span></label>
        ...
        <div class="col-sm-12 col-md-6 col-lg-6"><br><br><br><br>
            <input type="submit" value="Enviar datos administrador" name="boton" ><br><br>
        </div>
</form>
