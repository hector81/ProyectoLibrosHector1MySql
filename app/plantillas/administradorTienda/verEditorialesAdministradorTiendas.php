    ...
    echo '<tbody>';
      echo '<thead>';
        echo '<tr>';
          ...
          <form id="verLibrosEditorialesAdministradorTiendas" name="verLibrosEditorialesAdministradorTiendas" action="index.php?ctl=verLibrosEditorialesAdministradorTiendas" method="POST">
