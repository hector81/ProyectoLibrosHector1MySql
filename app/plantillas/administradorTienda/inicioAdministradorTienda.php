    ...
    echo '<div class="row">';
		echo '<div class="col-xs-12 col-md-12 col-lg-12 content_home">';
			...
			echo '<p class="pull-center">
				<span><a href="index.php?ctl=verLibrosPorBoton&categoria='.$arrayLibro['NombreCategoria'].'&redireccion=administradorTienda">
				<button type="button" class="btn btn-default">' . $arrayLibro['NombreCategoria'] . '</button></a></span>
				<span><a href="index.php?ctl=verLibrosPorBoton&subCategoria='.$arrayLibro['NombreSubCategoria'].'&redireccion=administradorTienda">
				<button type="button" class="btn btn-default">' . $arrayLibro['NombreSubCategoria'] . '</button></a></span>
				<span><a href="index.php?ctl=verLibrosPorBoton&editorial='.$arrayLibro['NOMBRE_EDITORIAL'].'&redireccion=administradorTienda">
				<button type="button" class="btn btn-default">Editorial:' . $arrayLibro['NOMBRE_EDITORIAL'] . '</button></a></span></p><br>';

			echo '<ul class="list-inline">';
				echo '<li><a href="index.php?ctl=verLibrosPorBoton&yearPublicacion='.$arrayLibro['YearPublicacion'].'&redireccion=administradorTienda">
        <button type="button" class="btn btn-default">Año publicación
				: ' . $arrayLibro['YearPublicacion'] . '</button></a></li>';
				echo '<li><a href="index.php?ctl=verLibrosPorBoton&autor='.$arrayLibro['nombre_autor'].'&redireccion=administradorTienda">
        <button type="button" class="btn btn-default">Autor
				: ' . $arrayLibro['nombre_autor'] . '</button></a></li>';
				echo '<li><strong>Precio :' . round($arrayLibro['PVP'] ,2) . ' €</strong></li>';
			echo '</ul>';
			echo '<ul class="list-inline">';
				echo '<li><p class="lead">';
