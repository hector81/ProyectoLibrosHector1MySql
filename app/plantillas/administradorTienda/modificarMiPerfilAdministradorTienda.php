...
<form class="modificarMiPerfilAdministradorTienda" name="modificarMiPerfilAdministradorTienda" method="POST" action="index.php?ctl=modificarMiPerfilAdministradorTiendaAdministrador">
  ...
  <input type="hidden" value="<?php echo $idTienda; ?>" name="idTienda" id="idTienda"><br><br>
