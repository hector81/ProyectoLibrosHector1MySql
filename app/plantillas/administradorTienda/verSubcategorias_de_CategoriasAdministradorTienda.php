...
foreach ($subCategorias as $key1 => $value1) {
    ...
    echo '<form name="verLibrosPorSubCategoriaAdministradorTienda" class="verLibrosPorSubCategoriaAdministradorTienda" method="POST"
    action="index.php?ctl=verLibrosPorSubCategoriaAdministradorTienda">';
    echo '<ul>';
        ...
        echo 'Libros disponibles : '.$NUMERO_LIBROS.'</span>';
            ...
            echo '</p></a>';
        echo '<button type="submit" class="btn btn-default" name="verLibrosPorSubCategoriaAdministradorTienda">Ver libros por subcategorias</button>';
